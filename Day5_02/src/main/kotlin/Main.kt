...
fun main(args: Array<String>) {
    ...
    fun addToTop(stackNum: Int, crates: List<Char>){
        stacks[stackNum-1].addAll(0, crates)
    }

    fun popTopN(stackNum: Int, numCrates: Int) : List<Char> {
        val topN = stacks[stackNum-1].slice(0 until numCrates)
        stacks[stackNum-1].subList(0,numCrates).clear()
        return topN
    }
    ...
    fun processMove(line: String){
        ...
        addToTop(to, popTopN(from, number))
    }
